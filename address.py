...
def test_p2pk_from_privkey(privkey: str, addr: str = None, debug: bool = False):
    ...
    if addr is not None:
        if address == addr:
            print("Test Passed")
            print(
                f"Private Key: {privkey.serialize()} -> Public Key: {pubkey.serialize().hex()} -> Address: {address}\n"
            )
            return True
        else:
            print("Test Failed")
...
def run_tests():
    ...
    ANDREAS_PRIVKEY_DECIMAL_1 = (
        26563230048437957592232553826663696440606756685920117476832299673293013768870
    )
    ANDREAS_PRIVKEY_WIF_1 = "5JG9hT3beGTJuUAmCQEEmNaxAuMacCTfXuw1R3FCXig23RQHMr4K"
    ANDREAS_PRIVKEY_HEX_COMPRESSED_1 = (
        "3aba4162c7251c891207b747840551a71939b0de081f85c4e44cf7c13e41daa601"
    )
    ANDREAS_PRIVKEY_WIF_COMPRESSED_1 = (
        "KyBsPXxTuVD82av65KZkrGrWi5qLMah5SdNq6uftawDbgKa2wv6S"
    )
    ANDREAS_PUBKEY_COORDINATES = (
