...
class SigningContext:
    ...
    def taproot_sighash(
        ...
        """compute the BIP-341 / Taproot Common Signature Message ('sighash') for given input index and sign it"""
        ...
        extension = bytes.fromhex(message_ext) if message_ext else b""

        # second return value can be useful for debugging
        return tagged_hash("TapSighash", epoch + message + extension), message.hex()
