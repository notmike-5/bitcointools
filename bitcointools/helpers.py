...
def run_tests():
    ...
    print(
        f"Testing 0xdeadbeef\nExpected: deadbeef\nGot:\t {bytes_to_hex(b'\xde\xad\xbe\xef')}"
    )

    #
    # # Test Compact Sizes
    #
    print("\nTesting get_compact_size() single byte case (0x0-0x252)")
    ...
    for i in range(0, 252):
        ...
        ), f"Error: Expected: {expected_byte.hex()}\tGot: {size_byte.hex()}"

    print("\nTesting get_compact_size() edge cases\n")
